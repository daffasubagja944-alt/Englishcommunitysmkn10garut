...
const GlobalStyle = () => (
  <style>{`
    ...
    .ec-card:hover { border-color: var(--navy-600); }
    ...
    .ec-btn:hover { border-color: var(--navy-600); background: var(--navy-800); }
    ...
    .ec-btn.danger { border-color: var(--line); color: #c98a8a; }
    .ec-btn.danger:hover { background: #3a1f1f; border-color: #6b3535; color: #eaa; }
    ...
    .ec-input {
      ...
      color: var(--text-hi); border-radius: 7px; padding: 9px 12px;
    ...
    .ec-divider { height: 1px; background: var(--line); }

    .ec-badge {
      display: inline-flex; align-items: center; gap: 6px;
      font-size: 10.5px; letter-spacing: .4px; text-transform: uppercase;
      color: var(--text-lo); background: var(--navy-800);
      border-radius: 6px;
      padding: 5px 10px;
    }
    ...
    .ec-table tr:hover td { background: var(--navy-800); }
          ...
          <header style={{ position: "sticky", top: 0, zIndex: 20, display: "flex", alignItems: "center", gap: 12, padding: "16px 24px", background: "rgba(6,15,31,.85)", backdropFilter: "blur(8px)", borderBottom: "1px solid var(--line)" }}>
            ...
            <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 10 }}>
              ...
              {isAdmin ? (
                ...
                <span className="ec-badge" style={{ color: "var(--text-lo)", borderColor: "var(--line)", cursor: "pointer" }} onClick={() => goTo("admin")}><Lock size={12} /> Login</span>
              )}
            </div>
          </header>
