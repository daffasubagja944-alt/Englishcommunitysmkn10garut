    ...
    <div>
      ...
      {isAdmin && (
        <div className="ec-card" style={{ padding: 18, marginBottom: 18, display: "flex", gap: 14, flexWrap: "wrap", alignItems: "flex-end" }}>
          ...
          <ImportButton label="Impor dari Excel" onRows={handleImport} hint={`Wajib: nama. Opsional: nisn, kelas, jurusan, status. Kalau file punya kolom kelas, baris otomatis masuk ke kelas itu — kalau tidak, masuk ke Kelas ${kelas} yang sedang dipilih.`} />
        </div>
      )}
